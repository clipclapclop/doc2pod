...
const draft: EpisodeDraft = {
  title: "Test",
  description: "Test",
  blueprint: { sourceSummary: "Test", targetScriptWords: 10, budgetRationale: "Test", coverage: [{ id: "c", topic: "Test", importance: "essential" }] },
  turns: [
...
test("creates a safe fixed warning without review messages", () => {
  const text = warningText(["incomplete_coverage", "unsupported_claim"]);
